...
import com.tistory.jaimemin.effectivejava.ch03.item10.Color;
...
public class ColorPoint extends Point {
	...
	/**
	 * Point와 ColorPoint를 비교하면 대칭성 위배
	 */
	...
	/**
	 * ColorPoint와 같은 레벨에 있는 subclass를 구현하면 서로 equals를 호출하면서
	 * StackOverflow 발생 (순환참조)
	 */
